        ...
        children: [
           paymentController.isSelected.value==index
               ? Padding(
                 ...
                 child: Text('$index. Primary card',style: GoogleFonts.poppins(fontWeight: FontWeight.w500,fontSize: 15.sp)),
               )
               :Padding(
             padding:  EdgeInsets.only(left: 5.w,top: 1.h,bottom: 1.h),
                 child: Text('',style: GoogleFonts.poppins(fontWeight: FontWeight.w600,fontSize: 12.sp,color: Colors.grey)),
               ),

          CreditCard(
              cardNumber: "1020 3030 4050 6040",
              cardExpiry: "10/27",
              cardHolderName: "TheAkhilSarkar",
              cvv: "123",
              bankName: "Axis bank",
